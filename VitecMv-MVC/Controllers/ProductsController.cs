...
namespace VitecMv_MVC.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Titel,Description,Price,ImageURL")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Titel,Description,Price,ImageURL")] Product product)
        {
            if (id != product.ID)
            {
                return NotFound();
